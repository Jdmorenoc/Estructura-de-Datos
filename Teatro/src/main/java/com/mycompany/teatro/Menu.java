...
objlista.solicitarTurno(JOptionPane.showInputDialog(" Nombre "), JOptionPane.showInputDialog(" Documento "), JOptionPane.showInputDialog(" Genero "));
    ...
    private void numeroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numeroActionPerformed
       ...
       numeroboletas= Integer.parseInt(JOptionPane.showInputDialog(" Diga el numero de boletas a vender "));
        ...
        boletasrestantes =numeroboletas;
    ...
    private void atenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atenderActionPerformed
        ...
        if(nuboletas<= 3){
            if(nuboletas<=boletasrestantes){
                boletasrestantes-=nuboletas;
                JOptionPane.showMessageDialog(null, "Realizo la compra de "+ nuboletas + "boletas" );
            }else{
                JOptionPane.showMessageDialog(null, "No hay suficientes boletas" );
            }
        }else{
            JOptionPane.showMessageDialog(null, "El numero de boletas que desea comprar super el limite permitidas" );
        }       
